        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container">
                    <Link className="navbar-brand" to="/">Cloudbazzar</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <Link className="btn btn-danger me-2" to="/cart/"><i className='fas fa-shopping-cart'></i> <span id='cart-total-items'>{cartCount || 0}</span></Link>
